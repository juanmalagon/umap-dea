...
def wrapper_function(params_dict: dict,
                     results_dir: str):
    """
    Wrapper function to run the simulation study.
    """
    ...
    for i in range(params_dict['nr_simulations']):
        ...
        try:
            ...
            print(f'Error {e} in iteration {i}')
        print(f'Finished iteration {i}')

    export_results(evaluation_df_list, errors_list, params_dict, run_serial,
                   results_dir)
